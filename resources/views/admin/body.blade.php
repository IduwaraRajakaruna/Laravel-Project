<h2 class="h5 no-margin-bottom">Dashboard</h2>
        ...
        <section class="no-padding-bottom">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-4">
                <div class="block bar-chart no-margin-bottom">
                  <canvas id="barChartExample1"></canvas>
                </div>
                <div class="block bar-chart">
                  <canvas id="barChartExample2"></canvas>
                </div>
              </div>
              <div class="col-lg-8">
                <div class="block line-cahrt">
        ...
        <section class="no-padding-bottom">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-6">
                <div class="block stats-2-block d-flex">
                ...
                <div class="block stats-3-block d-flex">
                  ...
                  <div class="text-center stats-3 d-flex justify-content-between">
        ...
        <section class="no-padding-bottom">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-4">
                <div class="block text-center user-block">
            ...
            <div class="block public-user-block">
        ...
        <section class="margin-bottom-sm">
          <div class="container-fluid">
            <div class="row d-flex align-items-stretch">
              <div class="col-lg-4">
                <div class="block stats-with-chart-1">
